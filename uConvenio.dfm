object fConvenio: TfConvenio
  ...
  object cdsConvenio: TClientDataSet
    ...
    object cdsConveniodesconto: TFloatField
      FieldName = 'desconto'
    end
    object cdsConveniotelefone: TStringField
      FieldName = 'telefone'
    end
  end
