...
procedure TfCstPis.btnExcluirClick(Sender: TObject);
begin
  cdsCargos.Delete;
end;

procedure TfCstPis.btnImprimirClick(Sender: TObject);
begin
  cdsCargos.Cancel;
end;

procedure TfCstPis.btnNovoClick(Sender: TObject);
begin
  cdsCargos.Append;
...
procedure TfCstPis.btnSalvarClick(Sender: TObject);
begin
  cdsCargos.Post;
...
procedure TfCstPis.grdCargoKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
var i : Integer;
begin
...
procedure TfCstPis.imgSairClick(Sender: TObject);
begin
  Close;
end;
